...
**BeatBerry** is a media format conversion app for macOS.
It uses a SwiftUI-based UI and a bundled FFmpeg engine, so users can convert audio and video files without installing Conda or Python.
...
- **Smart detection**: automatically detects file type and adjusts format options
- **Visual indicators**: color-coded badges (🔵 Audio, 🟣 Video)
